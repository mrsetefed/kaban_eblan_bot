HELP_TEXT_COMMON = (
    ...
    "Проще всего написать /upd без параметров: выбираешь месяц, жмёшь на дни (✅ можешь играть, ❌ занят) и нажимаешь \"Сохранить\".\n\n"
    "А еще можно текстом. Для этого впиши команду /upd, после чего укажи месяц-даты, которые хочешь поменять/добавить и через пробел проставь, что ты хочешь в этот день: + если можешь играть, - если нет. Команды можно смешивать, указывая каждую через запятую.\n\n"
    "*Пример:*\n"
    "```\n"
